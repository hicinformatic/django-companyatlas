    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.CharField(help_text='Company domain (e.g., example.com)', max_length=255, unique=True)),
                ('siren', models.CharField(blank=True, help_text='French SIREN number', max_length=20, null=True)),
                ('vat_number', models.CharField(blank=True, help_text='VAT/Tax identification number', max_length=50, null=True)),
                ('stock_symbol', models.CharField(blank=True, help_text='Stock ticker symbol', max_length=10, null=True)),
                ...
                ('enriched_at', models.DateTimeField(blank=True, help_text='Last enrichment timestamp', null=True)),
                ('enrichment_data', models.JSONField(blank=True, default=dict, help_text='Raw enrichment data')),
